...
var mlkem768X25519 = &hybridKEM{
	...
	pqNewPublicKey: func(data []byte) (mlkem.Encapsulator, error) {
		return mlkem.NewEncapsulationKey768(data)
	},
	pqNewPrivateKey: func(data []byte) (mlkem.Decapsulator, error) {
...
func NewHybridPublicKey(pq mlkem.Encapsulator, t *ecdh.PublicKey) (PublicKey, error) {
	switch t.Curve() {
	case ecdh.X25519():
...
// [ecdh.ecdhKeyExchanger] and [mlkem.Decapsulator] (e.g. a hardware key).
// Otherwise, applications should use the [KEM.NewPrivateKey] method of e.g.
// [MLKEM768X25519].
func NewHybridPrivateKey(pq mlkem.Decapsulator, t ecdhKeyExchanger) (PrivateKey, error) {
...
func newHybridPrivateKey(pq mlkem.Decapsulator, t ecdhKeyExchanger, seed []byte) (PrivateKey, error) {
	switch t.Curve() {
	case ecdh.X25519():
...
var mlkem768 = &mlkemKEM{
	...
	newPublicKey: func(data []byte) (mlkem.Encapsulator, error) {
		return mlkem.NewEncapsulationKey768(data)
	},
	newPrivateKey: func(data []byte) (mlkem.Decapsulator, error) {
		return mlkem.NewDecapsulationKey768(data)
	},
	generateKey: func() (mlkem.Decapsulator, error) {
...
func NewMLKEMPublicKey(pub mlkem.Encapsulator) (PublicKey, error) {
	switch pub.(type) {
...
func NewMLKEMPrivateKey(priv mlkem.Decapsulator) (PrivateKey, error) {
